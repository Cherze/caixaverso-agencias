...
public class ExcelExporter {
    ...
    public static XSSFWorkbook exportToExcel(List<AgenciaDTO> agenciasDto) {
        ...
        String[] headers = {"CGC", "Nome", "Responsável", "CEP", "Logradouro", "Num", "Cidade", "UF", "Data Inauguração"};
        ...
        for (AgenciaDTO agenciaDto : agenciasDto) {
            ...
            row.createCell(4).setCellValue(agenciaDto.getLogradouro());
            row.createCell(5).setCellValue(agenciaDto.getNumero());
            row.createCell(6).setCellValue(agenciaDto.getCidade() != null ? agenciaDto.getCidade() : "");
            row.createCell(7).setCellValue(agenciaDto.getEstado() != null ? agenciaDto.getEstado() : "");
            row.createCell(8).setCellValue(agenciaDto.getDataInauguracao().toString());
        }
